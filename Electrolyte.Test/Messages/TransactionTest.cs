...
//					Assert.AreEqual(transaction.Item4[i].Item2, tx.Outputs[i].ScriptPubKey)
		...
		public void ValidateSig() {
			...
			using(BinaryReader reader = new BinaryReader(new MemoryStream(raw))) {
				...
				byte[] pubKey = new byte[] { 04, 0xEF, 0x96, 0xE3, 0xBC, 0xCC, 0x8F, 0xFF, 0x6B, 0x21, 0xD2, 0x8E, 0x81, 0xF6, 0x1C, 0x4A, 0x93, 0xCF, 0xE0, 0xF1, 0x33, 0x21, 0x4C, 0x95, 0x47, 0xC0, 0xD6, 0x83, 0xA9, 0xFC, 0x12, 0xF5, 0x29, 0x22, 0x9C, 0x8D, 0x1A, 0xB2, 0x00, 0x04, 0xC0, 0xF7, 0xF1, 0x39, 0x61, 0x56, 0x6B, 0x65, 0x49, 0x2C, 0x62, 0x67, 0xFA, 0x45, 0x27, 0x84, 0xC0, 0x72, 0x4B, 0x4F, 0x54, 0x2E, 0x40, 0x01, 0xF1 };
