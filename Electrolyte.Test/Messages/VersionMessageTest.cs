...
//				0x35, 0x8D, 0x49, 0x32, // This checksum should be right
//
...
//				0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x01, 0x0D, 0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,	// Sender (2001:db8::ff00:42:8329 @ 27015)
...
//			),
			Tuple.Create(new byte[] {
				...
				0x76, 0x65, 0x72, 0x73, 0x69, 0x6F, 0x6E, 0x00, 0x00, 0x00, 0x00, 0x00, 																					// Message ("version     ")
				0x64, 0x00, 0x00, 0x00,																																		// Payload length (100 bytes)
				0x35, 0x8D, 0x49, 0x32, // This checksum is wrong
		...
		public void Write() {
			foreach(Tuple<byte[], VersionMessage> version in versions) {
				...
				using(BinaryWriter writer = new BinaryWriter(stream)) {
					version.Item2.WritePayload(writer);
//					version.Item2.Write(writer);	// TODO: Test full message

					Assert.AreEqual(ArrayHelpers.SubArray(version.Item1, 24), stream.ToArray());
				}
			}
		}
	}
