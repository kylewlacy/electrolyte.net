// http://bitcoinsharp.googlecode.com/svn/src/Core/EcKey.cs
/*
...
//		}
		...
		public ECKey(byte[] privKey) : this(new BigInteger(1, privKey)) { }

		/// <summary>
		/// Derive the public key by doing a point multiply of G * priv.
		/// </summary>
		static byte[] PublicKeyFromPrivate(BigInteger privKey) {
